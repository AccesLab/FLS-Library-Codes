...
public:
    ...
    {
        outtableDialog->setWindowTitle(QApplication::translate("outtableDialog", "Dialog", Q_NULLPTR));
        outtableadd->setText(QApplication::translate("outtableDialog", "Add Output", Q_NULLPTR));
    } // retranslateUi
