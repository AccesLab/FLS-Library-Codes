...
QT_MOC_LITERAL(4, 58, 17) // "on_addMF_released"

    },
    "outputDialog\0on_buttonBox_accepted\0\0"
    "on_buttonBox_rejected\0on_addMF_released"
};
...
void outputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        outputDialog *_t = static_cast<outputDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_buttonBox_accepted(); break;
        case 1: _t->on_buttonBox_rejected(); break;
        case 2: _t->on_addMF_released(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject outputDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_outputDialog.data,
      qt_meta_data_outputDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
